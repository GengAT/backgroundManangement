            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/user/findAll.do?size=${userList.pageSize}&page=1"
                                   aria-label="Previous">首页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/user/findAll.do?size=${userList.pageSize}&page=${userList.pageNum-1}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${userList.pages}" var="pageNum">
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageNum}&size=${userList.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/user/findAll.do?size=${userList.pageSize}&page=${userList.pageNum+1}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/user/findAll.do?size=${userList.pageSize}&page=${userList.pages}"
