        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${roleList.pages} 页，共${roleList.total} 条数据。 每页
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/role/findAll.do?size=${roleList.pageSize}&page=1"
                                   aria-label="Previous">首页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/role/findAll.do?size=${roleList.pageSize}&page=${roleList.size-1}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${roleList.pages}" var="pageNum">
                                <li>
                                    <a href="${pageContext.request.contextPath}/role/findAll.do?page=${pageNum}&size=${roleList.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/role/findAll.do?size=${roleList.pageSize}&page=${roleList.size+1}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/role/findAll.do?size=${roleList.pageSize}&page=${roleList.pages}"
